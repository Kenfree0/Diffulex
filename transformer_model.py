...
class TransformerNetModel(nn.Module):
    ...
    def __init__(
        ...
        if learned_mean_embed:
            ...
            self.cov_embed = nn.Parameter(th.randn(input_dims))
            nn.init.normal_(self.cov_embed, mean=0, std=input_dims ** -0.5)
        else:
        ...
        #gradnorm
        #########################################################
        #self.GradNorm = GradNormLoss(num_of_task=2)
        #self.wlt = self.GradNorm.w
        #self.gradnorm_forward = self.GradNorm.forward(self.wlt)
        #self.gradnorm_forward_backward = self.GradNorm.additional_forward_and_backward()
